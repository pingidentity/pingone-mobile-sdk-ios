...
/// \param completionHandler Will return NSError in case of an error.
///
- (void)approveWithCompletionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
@end
...
/// \param completionHandler Will return NSError in case of an error.
///
+ (void)pair:(NSString * _Nonnull)pairingKey completionHandler:(void (^ _Nonnull)(NSError * _Nullable))completionHandler;
...
/// \param completionHandler Will return NSError in case of an error. Will return an array with information on all the paired users.
///
