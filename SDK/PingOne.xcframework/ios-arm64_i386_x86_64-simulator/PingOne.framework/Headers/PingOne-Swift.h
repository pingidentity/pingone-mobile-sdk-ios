...
#ifndef PINGONE_SWIFT_H
#define PINGONE_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PingOne",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7PingOne18AuthenticatorModel")
...
SWIFT_CLASS("_TtC7PingOne18NotificationObject")
...
SWIFT_CLASS("_TtC7PingOne19OneTimePasscodeInfo")
...
SWIFT_CLASS("_TtC7PingOne11PairingInfo")
...
SWIFT_CLASS("_TtC7PingOne13PairingObject")
...
SWIFT_CLASS("_TtC7PingOne7PingOne")
...
/// Pair device
/// \param pairingKey The <code>String</code> value
///
/// \param completionHandler Will return NSError in case of an error.
///
...
/// \param pairingKey The <code>String</code> value
///
/// \param completionHandler Will return PairingInfo object containing data about pairing resolution, and NSError in case of an error. Documentation for pairing object error codes: https://apidocs.pingidentity.com/pingone/mobile-sdks/v1/api/#pingone-mobile-sdk-for-ios
///
...
/// \param idToken The <code>String</code> value
///
/// \param completionHandler Will return NSError in case of an error. Will return PairingObject in case further action is required, such as approving the pairing.
///
...
///   </li>
///   <li>
///     deviceToken: The <code>Data</code> received within application:didRegisterForRemoteNotificationsWithDeviceToken:
///   </li>
///   <li>
///     type: The <code>APNSDeviceTokenType</code> case.
///   </li>
///   <li>
...
/// \param userInfo The <code>[AnyHashable : Any]</code> received in the AppDelegate application(_:didReceiveRemoteNotification:fetchCompletionHandler:) method.
///
/// \param completionHandler Will return NSError in case of an error. Will return NotificationObject in case further action is required, such as approving or denying an authentication.
///
...
///   </li>
///   <li>
///     authenticationMethod: The <code>String</code> is the authentication method that was used to authenticate the user on the authenticating device, for example, fpt (fingerprint), face (facial recognition) etc. Refer to the “amr” (Authentication Method Reference) values in https://tools.ietf.org/html/rfc8176/#section-2 .
///   </li>
///   <li>
...
/// \param completionHandler Returns OneTimePasscodeInfo that contains data of the one time passcode if available, or error
///
...
/// \param completionHandler Will return NSError in case of an error. A supportId will be returned when the logs have been sent successfully. The supportId can then be forwarded to the Ping Identity support team to review the logs.
///
