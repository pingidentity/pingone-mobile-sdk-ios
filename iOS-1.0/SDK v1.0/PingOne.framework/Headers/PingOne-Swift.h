...
///   </li>
/// </ul>
+ (void)processRemoteNotificationAction:(NSString * _Nonnull)identifier forRemoteNotification:(NSDictionary * _Nonnull)userInfo completionHandler:(void (^ _Nonnull)(NotificationObject * _Nullable, NSError * _Nullable))completionHandler;
/// **************** Warning  ****************
...
typedef SWIFT_ENUM(NSInteger, APNSDeviceTokenType, closed) {
